...
namespace FanSpecV1
{
    class clsTable
    {
        ...
        public void FieldCreation()
        {
            ...
            AddFields("@FANDETAIL", "axmf", "AX Mounting Feet", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axgva", "AX Guide Vane", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axigl", "AX Inlet Gravity Louver", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axogl", "AX Outlet Gravity Louver", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axibs", "AX Inlet Bird Screen", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axobs", "AX Outlet Bird Screen", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axmgu", "AX Mesh Guard", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL","axtbox", "AX Terminal Box", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axinls", "AX Inlet Silencer", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axouts", "AX Outlet Silencer", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axicon", "AX Inlet Cone", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axocon", "AX Outlet Cone", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axbmi", "AX Bell Mouth Inlet", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axbmo", "AX Bell Mouth Outlet", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axrcu", "AX Roof Curb", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axrco", "AX Roof Cowl", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axwco", "AX Wall Cowl", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axinlt", "AX Inlet Transition", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axoutt", "AX Outlet transition", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axitcfb", "AX Inlet Transition cum Filter Box", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axwss", "AX Wall Supporting Structure", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axbeg", "AX Belt Guard", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axbbg", "AX Belt bearing Guard", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axbfr", "AX Base Frame", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axsrail", "AX Slide Rail", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axaul", "AX Auto Lubricator", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axvis", "AX Vibration Isolator", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axvsen", "AX Vibration Sensor", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axpsen", "AX Proximity Sensor", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axebu", "AX Earthing Bush", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axacen", "AX Acoustic Enclosure", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axbri", "AX Brass Ring", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axbseal", "AX Brass Seal", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axpgau", "AX Pressure gauge", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axlds", "AX Limit / disconnect switch", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axbear", "AX Bearings", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axfpul", "AX Fan pulleys", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axmpul", "AX Motor pulleys", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axbelts", "AX Belts", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axmot", "AX Motor", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axactu", "AX Actuator", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axmotca", "AX Motor Canopy", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axomfl", "AX Outlet Matching Flanges", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "aximfl", "AX Inlet Matching Flanges", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axmebel", "AX Metallic Bellows", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axoufc", "AX Outlet Flexible Connection", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axinfc", "AX Inlet Flexible Connection", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axindam", "AX Inlet Damper", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axinfil", "AX Inlet Filter", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axhin", "AX Housing insulation", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
            AddFields("@FANDETAIL", "axingv", "AX Inlet Guide Vane", SAPbobsCOM.BoFieldTypes.db_Alpha, 2, SAPbobsCOM.BoFldSubTypes.st_None, SAPbobsCOM.UDFLinkedSystemObjectTypesEnum.ulNone, SAPbobsCOM.BoYesNoEnum.tNO, "N", true);
